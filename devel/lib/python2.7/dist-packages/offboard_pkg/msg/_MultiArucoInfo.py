...
"""autogenerated by genpy from offboard_pkg/MultiArucoInfo.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','offboard_pkg/ArucoInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = offboard_pkg.msg.ArucoInfo()
        _v3 = val1.header
        start = end
        end += 4
