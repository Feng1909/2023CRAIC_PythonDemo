...
(cl:defclass <MultiArucoInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (aruco_infos
    :reader aruco_infos
    :initarg :aruco_infos
    :type (cl:vector offboard_pkg-msg:ArucoInfo)
   :initform (cl:make-array 0 :element-type 'offboard_pkg-msg:ArucoInfo :initial-element (cl:make-instance 'offboard_pkg-msg:ArucoInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MultiArucoInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiArucoInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offboard_pkg-msg:<MultiArucoInfo> is deprecated: use offboard_pkg-msg:MultiArucoInfo instead.")))
...
(cl:defmethod num_arucos-val ((m <MultiArucoInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard_pkg-msg:num_arucos-val is deprecated.  Use offboard_pkg-msg:num_arucos instead.")
  (num_arucos m))

(cl:ensure-generic-function 'aruco_infos-val :lambda-list '(m))
(cl:defmethod aruco_infos-val ((m <MultiArucoInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard_pkg-msg:aruco_infos-val is deprecated.  Use offboard_pkg-msg:aruco_infos instead.")
  (aruco_infos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MultiArucoInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'aruco_infos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'offboard_pkg-msg:ArucoInfo))
