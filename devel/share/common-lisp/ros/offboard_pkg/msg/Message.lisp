...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offboard_pkg-msg:<Message> is deprecated: use offboard_pkg-msg:Message instead.")))
...
(cl:defmethod message_type-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard_pkg-msg:message_type-val is deprecated.  Use offboard_pkg-msg:message_type instead.")
  (message_type m))

(cl:ensure-generic-function 'source_node-val :lambda-list '(m))
(cl:defmethod source_node-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard_pkg-msg:source_node-val is deprecated.  Use offboard_pkg-msg:source_node instead.")
  (source_node m))

(cl:ensure-generic-function 'content-val :lambda-list '(m))
(cl:defmethod content-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard_pkg-msg:content-val is deprecated.  Use offboard_pkg-msg:content instead.")
  (content m))
